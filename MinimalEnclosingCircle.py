...
#mec = minimum_enclosing_circle([ [ 0, 0 ], [ 0, 1 ], [ 1, 0 ] ])

#print("Center = { ",mec[0][1],",",mec[0][1],"} Radius = ",round(mec[1],6))

#mec2 = minimum_enclosing_circle([ [ 5, -2 ],[ -3, -2 ], [ -2, 5 ], [ 1, 6 ], [ 0, 2 ] ])

#print("Center = {",mec2[0][0],",",mec2[0][1],"} Radius = ",mec2[1])

mec3 = minimum_enclosing_circle([[7, 7], [9, 10], [6, 9], [10, 4], [9, 6], [8, 7], [10, 10], [2, 2], [1, 2], [7, 6]])

print("Center = {",mec3[0][0],",",mec3[0][1],"} Radius = ",mec3[1])
